        ...
        if not self.ball_served:
            ...
            if y - self.old_y > 0 :
                if x-self.old_x != 0:
                    ...
                    if(scene_info["platform_1P"][0] + 40 > self.predict_x):
                        command = "MOVE_LEFT"
                    elif(scene_info["platform_1P"][0] + 40 < self.predict_x):
                        command = "MOVE_RIGHT"
                    else:
                        command = "NONE"
            else:
